...
const RepoFilters = ({sort, order, onSortChange, onOrderChange, disabled}) => {
    const selectClass = "px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white text-sm focus:outline-none focus:rimg-2 focus:ring-blue-500 focus:border-transparent disabled:opacity:50 disabled:cursor-not-allowed ";
